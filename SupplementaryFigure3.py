...
for model_i, a, in zip(range(n_models), range(n)):
    ...
    print('Historical, Model: '+cmip5_data_in[model_i]) # print the name of the model being considered
    model = cmip5_data_in[model_i] # seleting the models
...
#%%
fig_historical.savefig('paper_figures/SupplementaryFigure3_v1.pdf', bbox_inches='tight')
plt.close()
